...
export class DraggableTrayIcon extends GObject.Object {
    ...
    _init(actor, appId, onDragStateChange) {
        super._init();
        this._actor = actor;
        this._appId = appId;
    ...
    _teardownDraggable() {
        ...
        if (!isDisposed(this._actor)) {
            ...
            // dnd.js never removes the start gesture it attached, left in place
            // it keeps starting drags after teardown, one more per re-enable.
            this._actor.remove_action(this._draggable.startGesture);
